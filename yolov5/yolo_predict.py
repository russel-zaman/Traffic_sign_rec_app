...
def run(
    ...
    exist_ok=True,  # existing project/name ok, do not increment ------changed
        ...
        for i, det in enumerate(pred):  # per image
            ...
            if len(det):
                ...
                for c in det[:, 5].unique():
                    ...
                    print("printing prediction:")##try
                    print(names[int(c)])##try
                    print(s)##try
...
class entry:
    #def __init__(self):
    def entry_point(self,weights,source,imgsz,project,save_txt):
        ...
        print("in entry_point() before run ")
        #object_of_run=run
        result=run(**vars(self))
        return result
